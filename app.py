...
app.config['mongo "mongodb+srv://aquesidilly.yjxkk.mongodb.net/aquesidilly" --username PY-aquesidilly'] = os.environ.get("mongo "mongodb+srv://aquesidilly.yjxkk.mongodb.net/aquesidilly" --username PY-aquesidilly")
